...
# Reading a .vti file and retrieving the image dataset
...
# Generating white bounding box outline using vtkOutlineFilter
...
# Setting up Volume Properties and optional Phong Shading
...
# Mapping the volume data to the volume actor and setting up the renderer
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="3D Volume Rendering with Phong Shading Option")
    parser.add_argument("--phong", choices=["yes", "no"], default="no",
                        help="Enable Phong shading (yes or no). Default is no.")
